        ...
        corrected_invoice: `
          <div style="font-family:Arial, sans-serif; font-size:14px;">
            ...
            <table style="width:100%; border-collapse:collapse; margin-bottom:12px;">
              ...
              <tr>
                <td colspan="3" style="border:1px solid #ccc; padding:8px; background:#dfe7ff; text-align:right; font-weight:bold;">Total Due</td>
                <td style="border:1px solid #ccc; padding:8px; background:#dfe7ff; text-align:right; font-weight:bold;">£${totalDue.toFixed(2)}</td>
              </tr>
